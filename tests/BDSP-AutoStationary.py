...
seed = r.state()
advances = 0
print("Auto DexScroll to Stationary")
print("Make sure you are pressed up against the Pokemon <3")
print()
print("Initial Seed")
...
while True:
    ...
    while r.state() != currSeed:
        ...
        if r.state() == currSeed:
            ...
            if not reachedTarget and botFlag and advances >= targetAdvances - 115:
                for i in range(2):
                    b.click("B")
                    b.pause(0.8)
                    b.click("B")                
